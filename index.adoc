...
image::DiagramaCasosUs.drawio.png[][width=100%]
...
image:images/mobile_inici.png[width=200] image:images/mobile_reserva.png[width=205]

[[web]]
=== 4.2 Web - admin

image::images\web_inici.png[width= 500]
image::images\web_reserva.png[width= 500]
